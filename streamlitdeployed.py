...
# ------------------------------------------------------------------
# Streamlit MUST start with page_config
# ------------------------------------------------------------------
...
# IMPORTANT: Streamlit Cloud cannot resolve api.openrouter.ai
# So we use the stable root-domain endpoint:
OPENROUTER_API_URL = "https://openrouter.ai/api/v1/chat/completions"

DEFAULT_MODEL = "qwen/qwen3-235b-a22b-2507"

# ------------------------------------------------------------------
# OpenRouter wrapper (Cloud-compatible endpoint)
# ------------------------------------------------------------------
...
# Streamlit UI
# ------------------------------------------------------------------
st.title("CrisisMMD 4-task Assistant (OpenRouter-enabled)")

with st.sidebar:
    st.header("API Settings")
    api_key_input = st.text_input("OpenRouter API key (stored in secrets OK)", type="password")
...
if st.button("Generate Response"):
    if not uploaded_image:
        ...
        st.success("Image + text accepted. Preparing prompt...")

        # Temporary stub outputs
        stub_outputs = {
